...
var addProcess = function (process, client, callback) {

  client.zadd('jobSet', 1000 , JSON.stringify(process), function (err) {
    if (err) {
...
var updateScore = function (client, time, callback) {

  var multiQueue = client.multi();
  var newScore;
  var elem;
  client.zrange('jobSet', 0, -1, 'withscores', function (err, replies) {
...
var getFirstElement = function (client, callback) {

  client.zrange('jobSet', -1, -1, function (err, res) {
    callback(res);
  });
}
